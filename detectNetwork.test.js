...
describe('Switch', function(){
  var expect = chai.expect;
  var cardPrefix4 = [4903, 4905, 4911, 4936, 6333, 6759];
  var cardPrefix6 = [564182, 633110];
  for (var i = 0; i <= 5; i++) {
    (function(i) {
      it('has a prefix of ' + cardPrefix4[i] + ' and a length of 16', function () {
        expect(detectNetwork(cardPrefix4[i].toString() + '123456789012')).to.equal('Switch');
      });

      it('has a prefix of ' + cardPrefix4[i] + ' and a length of 18', function () {
        expect(detectNetwork(cardPrefix4[i].toString() + '12345678901234')).to.equal('Switch');
      });

      it('has a prefix of ' + cardPrefix4[i] + ' and a length of 19', function () {
        expect(detectNetwork(cardPrefix4[i].toString() + '123456789012345')).to.equal('Switch');
      });
    })(i)
  }
  ...
  for (var j = 0; j <= 1; j++) {
    (function(j) {
      it('has a prefix of ' + cardPrefix6[j] + ' and a length of 16', function () {
        expect(detectNetwork(cardPrefix6[j].toString() + '1234567890')).to.equal('Switch');
      });

      it('has a prefix of ' + cardPrefix6[j] + ' and a length of 18', function () {
        expect(detectNetwork(cardPrefix6[j].toString() + '123456789012')).to.equal('Switch');
      });

      it('has a prefix of ' + cardPrefix6[j] + ' and a length of 19', function () {
        expect(detectNetwork(cardPrefix6[j].toString() + '1234567890123')).to.equal('Switch');
      });
    })(j)
  }
